...
public class SubjectPdfActivity extends AppCompatActivity {
    ...
    subjectPdfAdapter subjectPdfAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        subjectPdfAdapter = new subjectPdfAdapter(getApplicationContext(), img, heading, num);
        recyclerView.setLayoutManager(new GridLayoutManager(getApplicationContext(), 2));
        recyclerView.setAdapter(subjectPdfAdapter);
